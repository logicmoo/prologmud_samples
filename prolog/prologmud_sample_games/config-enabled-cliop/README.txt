...
config files, which are located in the directory:
    ...
    /home/prologmud_server/Cliopatria/config-available

For example, to enhance the system setup   for development, you may wish
to do:

    ==
    ln -s /home/prologmud_server/Cliopatria/config-available/debug.pl
    ==

This application may  provide   additional  application-specific example
configuration files.

@see	/home/prologmud_server/Cliopatria/config-available/README.txt
